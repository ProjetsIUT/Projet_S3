...
<h1>Détails de la matière <?php echo htmlspecialchars($mnommatiere).'' ?><a class=bouton href="index.php?controller=matières&action=readAll">Retour à la liste des matières</a></h1>
